...
修复发布：`21984ab` 构建为 `candela-syncer:t02-null-20260916`（`sha256:f59fce42b69398ca264df3330093a93a3c92de4f6b571e5ac5e5509acb1a33a3`），已更新演示站 syncer 并应用 v2 迁移，web／MySQL／机器人容器保持不变。原失败任务原样保留；重新发起的回填 [10bb72ba1441c47ac1fd0c38607f47f3](https://demo.candlea.cn/admin/data?run=10bb72ba1441c47ac1fd0c38607f47f3) 已成功，覆盖 `20041231..20260915`，处理 5,273 条、22/22 分段，目录与执行记录一致。回退镜像为 `candela-syncer:before-null-20260916`；保留 nullable 列与已有数据，不把空值改为零。
