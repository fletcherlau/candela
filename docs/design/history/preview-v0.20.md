...
[查看已选定的完整报告](http://127.0.0.1:4173/design-preview?english=source-serif&chinese=serif-light&numbers=source-serif#overview)：中文细宋 + 英文 Source Serif 4 + 数字 Source Serif 4。最新 B 版报告截图、[检查记录](../preview/selected-english-font-checks.json)。
...
| 方案 | 打开样板 | 图版截图 | 手机截图 |
| --- | --- | --- | --- |
| A · 暖纸书页 | [试读 A](http://127.0.0.1:4173/design-preview?paper=warm#paper-surfaces) | 暖灰与微暖白 | A 手机 |
| B · 净白留白（已选定） | [查看 B](http://127.0.0.1:4173/design-preview?paper=white#paper-surfaces) | 纯白与轻细边 | B 手机 |
| C · 轻叠纸页 | [试读 C](http://127.0.0.1:4173/design-preview?paper=layered#paper-surfaces) | 灰衬底与白纸投影 | C 手机 |

三版首屏：A / B / C。[参考来源](../references/paper/README.md)包括实际 Anthropic / 有知有行截图，以及 ChatGPT 官方展示的界面图；ChatGPT 交互首页触发验证，没有把验证页当作参考。
...
A2 定稿截图：折线图 / 热力图；[验证记录](../preview/selected-palette-checks.json)。
...
最终截图：桌面 / 手机 / 详情弹窗 / 错误状态；[交互与响应式检查](../preview/component-study-checks.json)。
